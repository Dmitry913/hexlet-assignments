...
public class ProductsController {
    ...
    public ProductDTO update(@RequestBody ProductUpdateDTO productData, @PathVariable Long id) {
        Product productFromDB = productRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Product with id " + id + " not found"));
        productRepository.save(toEntityForUpdate(productData, productFromDB));
        return toDTO(productFromDB);
    }

    private Product toEntityForUpdate(ProductUpdateDTO dto, Product entity) {
